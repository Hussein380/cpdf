...
export function ImpactHero() {
  return (
    <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden bg-cpdf-darker pt-20">
      ...
      />
      <motion.div
        className="absolute bottom-0 right-1/4 w-80 h-80 rounded-full bg-cpdf-blue/15 blur-3xl pointer-events-none"
      ...
      <div className="relative z-10 max-w-4xl mx-auto container-padding text-center py-20">
        <FadeIn>
          <div className="inline-flex items-center gap-2 bg-cpdf-teal/10 border border-cpdf-teal/20 rounded-full px-5 py-2 mb-6">
            <TrendingUp size={14} className="text-cpdf-teal" />
            <span className="text-cpdf-teal text-sm font-semibold">Impact & Achievements</span>
          </div>
        </FadeIn>
        ...
        <SlideUp delay={0.2}>
          <p className="text-cpdf-muted text-xl leading-relaxed max-w-2xl mx-auto">
            Every dialogue facilitated, every leader trained, and every reform advocated
            for represents a step toward a stronger, more inclusive Kenyan democracy.
          </p>
        </SlideUp>
